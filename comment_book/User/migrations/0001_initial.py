    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('indentify', models.BooleanField(default=False)),
            ],
        ),
        migrations.CreateModel(
            name='BookList',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('star', models.IntegerField(validators=[django.core.validators.MaxValueValidator(10), django.core.validators.MinValueValidator(0)])),
        ...
        migrations.CreateModel(
            name='BookListIncludeBook',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Book.Book')),
                ('user_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='User.BookList')),
            ],
            options={
